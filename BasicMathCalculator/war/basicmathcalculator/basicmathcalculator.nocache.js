...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "basicmathcalculator" because\n';
  ...
  $wnd.__gwt_activeModules['basicmathcalculator'] = {
    'moduleName' : 'basicmathcalculator',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/basicmathcalculator.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['basicmathcalculator'].superdevmode = true;

  var expectedSuffix = '/basicmathcalculator.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + basicmathcalculator + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:basicmathcalculator';
  var devModeSessionKey = '__gwtDevModeSession:basicmathcalculator';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/basicmathcalculator/basicmathcalculator.nocache.js';
  ...
  $wnd.__gwt_activeModules['basicmathcalculator'].canRedirect = true;
  $wnd.__gwt_activeModules['basicmathcalculator'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING basicmathcalculator';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/basicmathcalculator?user.agent=' + ua + '&_callback=' + callback;
